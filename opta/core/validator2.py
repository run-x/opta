...
# Layer initialization validation checks
  # valid name
  # if parent then org_name is expected
  # provider one of the 4 clouds
  # same module not re-used in a layer
...
azure_validators[AzureOpta.tag] = AzureOpta
