...
class TestTerraform:
    ...
    def test_force_unlock_aws(self, mocker: MockFixture) -> None:
        ...
        mock_force_unlock_nice_run.assert_called_once_with(
            ...
            check=True, use_new_nice_run=True
        )
    ...
    def test_force_unlock_gcp(self, mocker: MockFixture) -> None:
        ...
        mock_force_unlock_nice_run.assert_called_once_with(
            ["terraform", "force-unlock", mock_get_gcp_lock_id.return_value], check=True, use_new_nice_run=True
        )
    ...
    def test_force_unlock_azure(self, mocker: MockFixture) -> None:
        ...
        mock_force_unlock_nice_run.assert_called_once_with(
            ["terraform", "force-unlock", mock_get_azure_lock_id.return_value], check=True,  use_new_nice_run=True
        )
