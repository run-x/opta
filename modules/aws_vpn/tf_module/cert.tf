...
resource "tls_locally_signed_cert" "server_issuer_cert" {
  cert_request_pem      = tls_cert_request.server_issuer_req.cert_request_pem
...
resource "aws_acm_certificate" "server" {
  private_key       = tls_private_key.server_issuer_key.private_key_pem
  certificate_body  = tls_locally_signed_cert.server_issuer_cert.cert_pem
