...
setup(
    ...
    description="Microservice generator",  # Optional
    ...
    # MANIFEST.in as well.
    package_data={"runxc": ["templates/**/*"]},  # Optional
    # Although 'package_data' is the preferred approach, in some case you may
    # need to place data files outside of your packages. See:
    # http://docs.python.org/3.4/distutils/setupscript.html#installing-additional-files
    #
    # In this case, 'data_file' will be installed into '<sys.prefix>/my_data'
    # data_files=[("runxc_templates", ["templates/application/meow.py"])],  # Optional
    ...
    entry_points={"console_scripts": ["runxc=runxc.cli:main"]},  # Optional
